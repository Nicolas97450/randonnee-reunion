-- ============================================================
-- Randonnee Reunion -- Leaderboard RPC functions
...
-- Permettre la lecture des activites des amis (pour les stories)
-- Politique supplementaire : un utilisateur peut voir les activites de ses amis
