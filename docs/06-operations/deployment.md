...
| Migrations 001→020 deployees | FAIT (20 migrations SQL, 22 fichiers) | - |
| Sprint Code Quality (onError, couleurs, refactoring) | FAIT (27/03) | - |
| Refactoring majeur 3 ecrans (20 composants extraits) | FAIT (04/04) | - |
| Tests unitaires (5 fichiers, 78+ tests) | FAIT — Jest non installe, a faire par Nicolas | - |
| Cache offline React Query | FAIT (code) — packages npm a installer | - |
| Notifications push (usePushNotifications + migration 020) | FAIT (code) — Firebase a configurer par Nicolas | - |
...
| Heberger politique de confidentialite | PRET (legal-pages/ cree, GitHub Pages a activer) | Oui |
| Heberger CGU | PRET (legal-pages/ cree, GitHub Pages a activer) | Oui |
| Branding (logo, icone, splash) | FAIT (icon.png 1024x1024, splash-icon.png, adaptive icons Android, brand-guide.html, design-tokens.json) | - |
...
**Tous les assets branding sont en place :**

| Asset | Fichier | Taille | Statut |
|---|---|---|---|
| Icone iOS | app/assets/icon.png | 1024x1024 px | FAIT |
| Splash screen | app/assets/splash-icon.png | 1284x1284 px | FAIT |
| Android adaptive foreground | app/assets/android-icon-foreground.png | Configure | FAIT |
| Android adaptive background | app/assets/android-icon-background.png | Configure | FAIT |
| Android monochrome | app/assets/android-icon-monochrome.png | Configure | FAIT |
| Favicon web | app/assets/favicon.png | Configure | FAIT |
| Brand guide | private/branding/brand-guide.html | Complet | FAIT |
| Design tokens | private/branding/design-tokens.json | Palette complete | FAIT |
| Logo selection | private/branding/logo-selection.html | Options de logo | FAIT |

**Configuration app.json :** icone, splash, adaptive icons Android tous references correctement.

### Reste a faire pour les stores
- [ ] Feature graphic Google Play (1024x500 px) — image promotionnelle
- [ ] Screenshots (6 iOS + 2 Android minimum) — a prendre sur device reel
- [ ] Nom definitif de l'app (actuel : "Randonnee Reunion")
...
*Document cree le 17 mars 2026 — Mis a jour le 4 avril 2026 (refactoring, cache offline, push notifications, legal-pages, migration 020)*
