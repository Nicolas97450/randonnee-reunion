...
## 6. Donnees de sentiers — Provenance [CARTE-02]

### Source des donnees
Les 710 sentiers et leurs traces GPS proviennent de **donnees geographiques publiques** relatives aux sentiers de randonnee de La Reunion. Les traces GPS correspondent a des itineraires physiques reels sur le terrain, releves et compiles a partir de sources ouvertes.

### Situation juridique
- Les traces GPS representent des faits geographiques (chemins physiques existants) et non des oeuvres originales protegees par le droit d'auteur.
- Les coordonnees GPS d'un sentier physique ne sont pas appropriables : elles decrivent la realite du terrain.
- Les descriptions des sentiers ont ete redigees de maniere originale pour l'application.
- **Aucun risque legal identifie** : les donnees sont des faits geographiques publics.

### Statut actuel
- [x] Donnees basees sur des faits geographiques publics
- [x] Descriptions originales redigees pour l'application
- [x] Aucune extraction de base de donnees protegee
